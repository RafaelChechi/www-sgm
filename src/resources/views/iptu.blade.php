            ...
            <div class="col-md-12">
                ...
                <div class="main-navigation">
                    <nav class="main-nav visible-md visible-lg">
                        <ul class="sf-menu">
                            <li><a href="{{url('/')}}">Home</a></li>
                            <li class="active"><a href="{{url('iptu')}}">Consulta IPTU</a></li>
                        </ul>
                    </nav>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="person" id="pf"
                                                   value="pf" checked>
                                        ...
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="person" id="pj"
                                                   value="pj">
                                    ...
                                    <div class="col-md-12">
                                        <input style="border: 1px #cacaca solid;" type="text" name="cpf" id="cpf"
                                               placeholder="Informe seu CPF/CNPJ:">
                                    </div>
                                    <div class="col-md-12">
                                        <button class="mainBtn" id="submit">Consultar</button>
                                        <button class="mainBtn" id="new" type="button"
                                                onclick="$('.tbody').find('tr').remove(); $('table').hide(); $('input[type=text]').val('')">
                                            Novo
                                        </button>
                                    </div>
                                </div>
...
<script src="{{asset('assets/js/medigo-custom.js')}}"></script>
